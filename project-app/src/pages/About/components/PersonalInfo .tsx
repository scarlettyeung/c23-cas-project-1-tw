...
function PersonalInfo(info: UserInfoProps) {
	...
	useEffect(() => {
		...
		// const hashtagsData = info.hashtagsData!;
	...
	return (
		<>
			...
			<Group position='center'>
				...
				<div> ({userSumOfEvent}) </div>
			</Group>

			{expYear ? <div>expYear: {expYear} </div> : <></>}
			...
			<div>===hashtags=== </div>
			<div>
				{!info.hashtagsData && <>No hashtags</>}
				{info.hashtagsData && <HashTags tags={info.hashtagsData} />}
			</div>
